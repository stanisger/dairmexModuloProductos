      ...
      <div class="app-dashboard-sidebar-inner bgGrey">
        <ul class="menu vertical">
          ...
          ?>
              <li>
              	  <a 
              	  href ="<?php echo base_url().'Requisicion/index'; ?>"
              	  class="<?php echo (strpos($_SERVER['REQUEST_URI'], 'Requisicion/index')
              	                  || strpos($_SERVER['REQUEST_URI'], 'Requisicion/detalles')) ? 'is-active':''; ?>"> 
          ...
          ?>
                <li>
                    ...
                    <i class="fi-page colorBlueDark"></i><span class="app-dashboard-sidebar-text bold">Requesiciones recientes</span>
                    </a>
                </li>
                 <li>
